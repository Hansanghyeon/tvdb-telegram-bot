...
import search_res from './search_res.json' assert { type: "json" }
import series_res from './series_res.json' assert { type: "json" }

Deno.test("tvdb에서 검색한 search, series 데이터를 텔레그램 메세지로 변환", () => {
  const test_res = {
    search: search_res,
    series: series_res,
  }
  ...
  assertObjectMatch(result, {
    thumbnail: 'https://artworks.thetvdb.com/banners/v4/series/407520/posters/63aa960baeb43.jpg',
